...
<ul style={{textAlign: 'left', fontSize: '1.5em'}}>
  <Appear>
    <li>Test at the hightest level that makes sense.</li>
...
<CodeSurfer
  ...
  steps={[
    ...
    {lines: [7], notes: 'Click on the button'},
    {lines: [8], notes: 'Assert value is what you expext'},
  ]}
/>
---
## DEMO
...
- Slides available at http://rethinking-testing.netlify.com
